...
class PostController extends Controller
{
    ...
    public function index(Request $request): View
    {
        $posts = Post::query()
            ...
            ->withAggregate('category', 'title') //Permet de faire une sous requete sur la relation category
            //category a une relation BelongsTo avec Post
            //Quand on a une relation BelongsTo on peut la préciser dans notre withAggregate et dans notre préciser title par exemple.
            //Ce qui fait qu'il va juste récupérer le titre de la catégorie du post
